...
public:
    ...
    vector<Particle*> getNeighbors(ofVec2f location, float radius);
    ...
    void addRepulsionForce(ofVec2f location, float radius, float scale);
    void addAttractionForce(const Particle& particle, float radius, float scale);
    void addAttractionForce(ofVec2f location, float radius, float scale);
    void returnToOrigin(const Particle& particle, float radius, float scale);
    void returnToOrigin(ofVec2f location, float radius, float scale);
    void addForce(const Particle& particle, float radius, float scale);
    void addForce(ofVec2f targetLoc, float radius, float scale);
    void update();
